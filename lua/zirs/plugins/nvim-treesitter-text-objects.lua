			...
			textobjects = {
				select = {
					...
					keymaps = {
						...
						["a:"] = { query = "@property.outer", desc = "Select outer part of an object property", expr = true },
						["i:"] = { query = "@property.inner", desc = "Select inner part of an object property", expr = true },
						["l:"] = { query = "@property.lhs", desc = "Select left part of an object property", expr = true },
						["r:"] = { query = "@property.rhs", desc = "Select right part of an object property", expr = true },
